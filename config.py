...
def argument_parser():
    ...
    parser.add_argument("--lr_ft", type=float, default=1e-3, help='learning rate of feature extractor')
    parser.add_argument("--lr_new", type=float, default=1e-3, help='learning rate of classifier_base')
